...
<body>
  ...
  <nav class="navbar">
    <div class="sectionx top">
      ...
      <div class="functions">
        <a href="car-view.php" class="item">
          <i class="fa-solid fa-user" style="color: #ffffff;"></i>
          <div class="text">Your Cars</div>
        </a>
        <a href="add-car.php" class="item">
    ...
    <div class="bottom">
      <div class="sectionx wrapper">
        ...
        <div class="rightPart">
          <div class="menu">
            <a href="account.php" class="menuItem">Home</a>
    ...
    <section class="centeralize featured">
      ...
      <div class="featuredCars">
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          echo "<a class='carCard' href='car-details.php?id=" . $row['cars_id'] . "'>" . "
                        <div class='img'>
